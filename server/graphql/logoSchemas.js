    ...
    fields: function () {
        return {
            ...
            updateLogo: {
                ...
                resolve(root, params) {
                    return LogoModel.findByIdAndUpdate(params.id, { text: params.text, color: params.color, backgroundColor: params.backgroundColor, borderColor: params.borderColor, fontSize: params.fontSize, borderRadius: params.borderRadius, borderWidth: params.borderWidth, padding: params.padding, margin: params.margin, lastUpdate: new Date() }, function (err) {
